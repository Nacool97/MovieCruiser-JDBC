...
public class MovieItemDaoSqlImpl implements MovieDao {
	...
	ArrayList<Movies> movieList=null;
		...
		Movies movieItem=new Movies((long)rs.getInt(1),rs.getString(2),rs.getString(3),b,rs.getDate(5),rs.getString(6),t);
	...
	public ArrayList<Movies> getMoviesListCustomer() {
		...
		Movies movieItem=new Movies(id,title,rs.getString(3),b,dateOfLaunch,genre,t); 
		System.out.println(movieItem);
		movieList.add(movieItem);
		} 
